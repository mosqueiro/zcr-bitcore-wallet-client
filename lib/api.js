...
API.prototype.validateKeyDerivation = function(opts, cb) {
  ...
  function testHardcodedKeys() {
    ...
    if (xpriv.toString() != '32Paj1AYn1aQnFaXhKPYH1FA2jmh3VnemBo8wGxqvzvgTvXQzQv47UC2nA9YpQwCAXgJvH2q1qW3x6ULLPP92jWGz9FbmPE7R7obh95Rz6LFD6TW') return false;

    xpriv = xpriv.deriveChild("m/44'/0'/0'");
    if (xpriv.toString() != '32Paj1GMHhRGL69thKb1S63X5nXXEmJwN3MVztTdV6RNtBmywgof7khNhq1PswB8duxVnwuiivugXxvaa2CcTJau7hJwVJ66YfEkASDD8anPhN2u') return false;

    var xpub = Bitcore.HDPublicKey.fromString('2p5V2yEEVDPCKg29iUr3D9jne6jccYxzd76HPvjKSchY4HzMUmUDqN12yoXsYH2z4cMkhEjCoYNrf6wARv3jCfJy7qyV1bT6dHCoJGMXKJBj8AiY');
